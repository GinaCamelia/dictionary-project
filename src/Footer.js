    ...
    return (
      <div className="Footer">
        <div className="link-github mt-5">
              ...
              className="link"
              target="_blank"
              rel="noreferrer">Gina-Camelia Hodorogea </a> and hosted on <a href="https://leafy-granita-e5a9c7.netlify.app" target="_blank" rel="noreferrer" className="link">Netlify</a>
            </div>
